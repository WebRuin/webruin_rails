...
Rails.application.config.assets.precompile += %w( learn.scss )
Rails.application.config.assets.precompile += %w( play.scss )
Rails.application.config.assets.precompile += %w( code.scss )
